...
def create_acc_ui_msg(packer, CAN: CanBus, CP, main_on: bool, enabled: bool, fcw_alert: bool, standstill: bool,
                      hud_control, stock_values: dict, send_hands_free_msg: bool, send_ui: bool, tja_warn: int, tja_msg: int):
  """
...
def create_lkas_ui_msg(packer, CAN: CanBus, main_on: bool, lat_active: bool, steer_alert: int, hud_control,
  ...
  if lat_active and hud_control is not None:
    left_status = 0  # Default to None
    right_status = 0  # Default to None
  ...
  elif hud_control is not None:
    # Pass through stock values
    lines = stock_values["LaActvStats_D_Dsply"]
