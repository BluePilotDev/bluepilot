...
class CarController:
  def __init__(self, dbc_name, CP, VM):
    ...
    self.right_lc_modifier = 0.5 # how much to reduce curvature of right lane changes
    self.lc1_modifier = 0.85 # how much to reduce curvature during "starting lane change"
    self.lc2_modifier = 0.99 # how much to reduce curvature during "chanigng lanes"
